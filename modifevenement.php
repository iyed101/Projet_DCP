...
<div class="main">
            ...
            <form action="modifevenementaction.php" method="post">
                    <div class="txt_field">
                    <input type="text" name="codeevent" value="<?php echo $l['codeevent']; ?>"readonly >
                        
                    </div>
                    <div class="txt_field">
                    <input type="text" name="nom" value="<?php echo $l['nome']; ?>">
                    </div>
                    
                    <div class="txt_field">
                    <input type="text" name="description" value="<?php echo $l['description']; ?>">
                    </div>
                    <div class="txt_field">
                    
                    <input type="date" name="dated" value="<?php echo $l['dated']; ?>">
                    </div>
                    <div class="txt_field">
                    
                    <input type="date" name="datef" value="<?php echo $l['datef']; ?>">
                    </div>
